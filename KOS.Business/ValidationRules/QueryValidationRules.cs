...
namespace KOS.Business.ValidationRules
{
    ...
    public class GetBookByTitleValidator : CustomValidator<GetBookByTitleQuery>
    {
        ...
        {
            RuleFor(x => x.Title).MaximumLength(64).WithMessage("Must be maximum of 64 characters").NotEmpty().WithMessage(ValidatorMessage.IsNull);
        }
    }
    public class GetBooksByAuthorValidator : CustomValidator<GetBooksByAuthorQuery>
    {
        ...
        {
            RuleFor(x => x.Author).MaximumLength(64).WithMessage("Must be maximum of 64 characters").NotEmpty().WithMessage(ValidatorMessage.IsNull);
        }
    }
    public class GetBooksByGenreValidator : CustomValidator<GetBooksByGenreQuery>
    {
        ...
        {
            RuleFor(x => x.Genre).MaximumLength(64).WithMessage("Must be maximum of 64 characters").NotEmpty().WithMessage(ValidatorMessage.IsNull);
        }
    }
}
