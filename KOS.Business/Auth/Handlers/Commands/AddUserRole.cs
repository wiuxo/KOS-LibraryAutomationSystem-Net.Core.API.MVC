...
public class AddUserRole : IRequest<IResponse>
{
    ...
    public class AddUserRoleHandler : IRequestHandler<AddUserRole, IResponse>
    {
        ...
        public AddUserRoleHandler(IUserRoleRepository userRoleRepository, IRoleRepository roleRepository,
        ...
        public async Task<IResponse> Handle(AddUserRole request, CancellationToken cancellationToken)
        {
            ...
            var checkUserRole =
                await _userRoleRepository.GetAsync(x => x.RoleId == request.roleID && x.UserID == request.userID);
            ...
            if (checkRole == null) return new Response<UserRole>(null, false, "A role with this ID doesn't exist.");
                ...
                return new Response<UserRole>(null, false, "A user with this ID doesn't exist.");
            else if (checkUserRole != null)
                return new Response<UserRole>(null, false, "This user already has this role.");
